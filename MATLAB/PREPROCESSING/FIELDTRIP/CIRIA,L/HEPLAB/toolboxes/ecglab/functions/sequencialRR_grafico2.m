function indices=sequencialRR_grafico2(intervaloRR,eixo)
% usage:

janela_plotagem=[60 45 390 390]; %[55 45 584 320]
...
figure(101);clf;
set(101,'Position',[50,200,fig_largura,fig_altura])
...
set(plot(deltaRR,'r.'),'markersize',14),grid
